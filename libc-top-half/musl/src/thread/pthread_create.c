...
/* This function is generated by the linker and initializes the TLS area and 
 * __tls_base. It only initializes the TLS of the main module.
 */
...
int __pthread_create(pthread_t *restrict res, const pthread_attr_t *restrict attrp, void *(*entry)(void *), void *restrict arg)
{
	...
	// Now we initialize the TLS in wasi_thread_start
